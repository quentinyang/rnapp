...
export const aboutUserPushRoute = makeActionCreator(types.ABOUT_USER_PUSH_ROUTE);
...
export const aboutUserPopRoute = makeActionCreator(types.ABOUT_USER_POP_ROUTE, 'states');
