        ...
        let expList = expListData && expListData.map((item, index) => {
                ...
                return (
                    <View style={[styles.getExpItem, styles.row, expItem.last?{borderBottomWidth: 0}:null]} key={index}>
                        ...
                        <Text style={styles.expItemValue}>经验<Text style={{color: '#ff6d4b'}}> + <Text
                            style={{color: '#ff6d4b', fontSize: 23}}>{item.get('experience')}</Text></Text></Text>
                    </View>
                );
            });
                ...
                return (
                    <View style={[styles.row, styles.clubItem]} key={index}>
                        ...
                        <View style={[styles.flex, {flexDirection: 'column'}]}>
                            <View
                                style={[styles.progress, {width: progressWidth}, {backgroundColor: this.levelConfig[index]}]}></View>
                            <View style={[styles.progressDetail, {width: progressDetailWidth}]}>
                                <Text style={styles.font15}>{item.get('min')}</Text><Text
                                style={styles.font15}>{item.get('max')}</Text>
                            </View>
                        </View>
                    </View>
                );
